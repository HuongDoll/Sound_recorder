...
public class MainActivity extends AppCompatActivity {
    ...
    private static int FRAGMENT_CONTAINER = R.id.fragments_container2;
//    private static int FRAGMENT_CONTAINER_2 = R.id.fragments_container;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        //import dc thu vien fft r nay chay cai cau lenh kia thôi à. đúng r. thêm dòng
